      ...
      builder: (context) => _StrengthPRsDialog(
        ...
        onStrengthPRsUpdated: (updatedPRs) {
          final updatedProfile = ClientProfile(
            ...
            smartGoals: clientProfile.smartGoals,
            trainingExperience: clientProfile.trainingExperience,
            trainingLocation: clientProfile.trainingLocation,
            hobbiesInterests: clientProfile.hobbiesInterests,
            injuriesLimitations: clientProfile.injuriesLimitations,
            profilePictureUrl: clientProfile.profilePictureUrl,
            isSuspended: clientProfile.isSuspended,
            strengthPRs: updatedPRs,
            bodyMeasurementsCm: clientProfile.bodyMeasurementsCm,
            illnessDays: clientProfile.illnessDays,
          );
