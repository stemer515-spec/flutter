...
class _IllnessDayScreenState extends State<IllnessDayScreen> {
  ...
  void _saveProfile() {
    final updatedProfile = ClientProfile(
      ...
      fitnessGoals: widget.profile.fitnessGoals,
      smartGoals: widget.profile.smartGoals,
      trainingExperience: widget.profile.trainingExperience,
      trainingLocation: widget.profile.trainingLocation,
      hobbiesInterests: widget.profile.hobbiesInterests,
      injuriesLimitations: widget.profile.injuriesLimitations,
      profilePictureUrl: widget.profile.profilePictureUrl,
      isSuspended: widget.profile.isSuspended,
      strengthPRs: widget.profile.strengthPRs,
      bodyMeasurementsCm: widget.profile.bodyMeasurementsCm,
      illnessDays: _illnessDays,
    );
